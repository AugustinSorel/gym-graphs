...
type DeleteExerciseTagsParams struct {
	ExerciseID int32
	UserID     int32
}

func (q *Queries) DeleteExerciseTags(ctx context.Context, arg DeleteExerciseTagsParams) error {
	_, err := q.db.Exec(ctx, deleteExerciseTags, arg.ExerciseID, arg.UserID)
	return err
}
