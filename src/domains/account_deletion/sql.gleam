...
//// `./src/domains/account_deletion/sql`.
...
/// defined in `./src/domains/account_deletion/sql/create.sql`.
///
...
/// defined in `./src/domains/account_deletion/sql/delete_by_id.sql`.
///
/// > 🐿️ This function was generated automatically using v4.7.0 of
/// > the [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
...
/// defined in `./src/domains/account_deletion/sql/select_by_id.sql`.
///
/// > 🐿️ This type definition was generated automatically using v4.7.0 of the
/// > [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
...
/// defined in `./src/domains/account_deletion/sql/verify.sql`.
///
/// > 🐿️ This function was generated automatically using v4.7.0 of
/// > the [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub fn verify(
  ...
  "update account_deletion_sessions set user_identity_verified_at = now() where id = $1 and user_identity_verified_at is null;
"
  |> pog.query
  |> pog.parameter(pog.int(id))
  |> pog.returning(decoder)
